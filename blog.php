                ...
                <div class="blog_box_1">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <div class="btc_blog_indx_box_wrapper btc_blog_padder">
                            <div class="hs_blog_box1_img_wrapper sw_blog_cate_slider">
...
about decarbonising heat?</h5>
                            ...
                            <div class="btc_blog_indx_cont_bottom">
                                <div class="btc_blog_indx_cont_bottom_left">
                                    <p><i class="fa fa-user"></i> &nbsp;<a href="javascript:;">by Akshay</a></p>
                                </div>
                                <div class="btc_blog_indx_cont_bottom_right">
                                    <p><i class="fa fa-comments-o"></i> &nbsp;<a href="javascript:;">04 Comm.</a></p>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <div class="btc_blog_indx_box_wrapper  btc_blog_indx_box_wrapper_2 btc_blog_padder">
                            <div class="btc_blog_indx_img_wrapper">
                                <img src="images/news_2.jpg" alt="blog_img">
                                <div class="btc_blog_indx_date_wrapper">
                                    <a href="blog.php#!" class="waves-effect waves-light waves-ripple"><i class="fa fa-long-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="btc_blog_indx_cont_wrapper">
                                <p>june 16,2022</p>
...
about decarbonising heat?</h5>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="lest_news_box_wrapper btc_blog_padder">
                            <div class="btc_blog_indx_box_wrapper btc_blog_indx_box_wrapper_2">
                                <div class="lest_news_img_wrapper">
                                    <div class="blog_cate_text_box">
                                        <p>“ This is Photoshop's ion of Lorem sum. Proin gravida nibh vel velit auor uet. Aenean sollicitudin, lorem quis ndum auctor, nisi elit consequat ipsum, nc
                                            <br>sagittis sem nibh id elit.”</p>

                                    </div>
                                    <div class="btc_blog_indx_date_wrapper inr_blog_btn">
                                        <a href="blog.php#!" class="waves-effect waves-light waves-ripple"><i class="fa fa-long-arrow-right"></i></a>
                                    </div>
                                </div>
                                <div class="btc_blog_indx_cont_wrapper">
                            ...
                            <div class="btc_blog_indx_box_wrapper btc_blog_indx_box_wrapper_2">
                                ...
                                <div class="lest_news_img_wrapper">
                                    <div class="video_wrapper">
                                        <img src="images/img_11.jpg" alt="blog_img1" />
                                        <a href="https://www.youtube.com/watch?v=3Fnf8ofDqq4" class="play-trigger"><span><i class="fa fa-play"></i></span></a>
                                    </div>
