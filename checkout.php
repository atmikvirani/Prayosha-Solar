                ...
                <div class="checkout-form">
                        ...
                        <div class="column col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" id="billfname" name="fname" value="" placeholder="">
                                </div>

                                
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                    <div class="field-label">Last Name </div>
                                    <input type="text" id="billlname" name="lname" value="" placeholder="">
                                </div>
                                ...
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <input type="text" id="billemail" name="email" value="" placeholder="">
                                </div>

                                
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                    <div class="field-label">Phone</div>
                                    <input type="text" id="billphone" name="phone" value="" placeholder="">
                                </div>
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" id="billsaddress" name="saddress" value="" placeholder="Street address">
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input type="text" id="billcity" name="city" value="" placeholder="">
                                </div>

                                
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                    <div class="field-label">State</div>
                                    <input type="text" id="billstate" name="state" value="" placeholder="">
                                </div>

                                
                                <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                    <div class="field-label">Pincode</div>
                                    <input type="text" id="billpincode" name="pincode" value="" placeholder="">
                                </div>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="column col-md-6 col-sm-12 col-xs-12 checkout_form_2_wrapper">
                        <div class="btc_shop_single_prod_right_section related_pdt_shop_head checkout_heading">
                            ...
                            <!-- <input type="checkbox" id="sameAsShipping" name="sameAsShipping" onchange="copyShippingAddress()">  -->
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <div class="section3_copyright">
                            <p>Copyright 2022-23 <a href="index.php"> Prayosha Solar</a>. all right reserved - designed
                                by
